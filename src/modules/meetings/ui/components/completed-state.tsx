                        ...
                        <div className="px-4 py-5 gap-y-5 flex flex-col col-span-5">
                            ...
                            <div>
                                ...
                                components={{
                                    ...
                                    p: (props) => (
                                        <p className="text-2xl font-medium mb-6"{...props}/>
                                    ),
                                    ul: (props) => (
                                        <ul className="text-2xl font-medium mb-6"{...props}/>
                                    ),
                                    ol: (props) => (
                                        <ol className="text-2xl font-medium mb-6"{...props}/>
                                    ),
                                    li: (props) => (
                                        <li className="text-2xl font-medium mb-6"{...props}/>
                                    ),
                                    strong: (props) => (
                                        <strong className="text-2xl font-medium mb-6"{...props}/>
                                    ),
                                    code: (props) => (
                                        <code className="text-2xl font-medium mb-6"{...props}/>
                                    ),
                                    blockquote: (props) => (
                                        <blockquote className="text-2xl font-medium mb-6"{...props}/>
                                    ),
